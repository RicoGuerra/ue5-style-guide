...
*Ein weitgehend angemessener Ansatz für die Unreal Engine 4*

Stark inspiriert vom [Airbnb Javascript Style Guide](https://github.com/airbnb/javascript).

[![Analytics](https://ga-beacon.appspot.com/UA-80567399-1/repo?useReferrer)](#)

## Repo-Hinweis

Dieses Repository befindet sich nun unter https://github.com/Allar/ue5-style-guide. Der Haupt-Branch dieses Repositories wurde in `main` umbenannt.

## Dieser Leitfaden ist für die UE4. Für die UE5/v2, siehe v2-Branch.
## Linter- und Style-Guide-Dokumentation

Weitere technische Dokumentation zu Linter und dem Style Guide befindet sich auf der folgenden Seite: [ReadTheDocs](https://ue4-style-guide.readthedocs.io/en/latest/).

## Diesen Style Guide diskutieren

Der öffentliche Discord-Channel von Gamemakin LLC ist unter folgendem Link zu finden:  http://discord.gamemak.in. Es gibt auch einen #linter Kanal, auf dem man sich über den Style-Guide und das Linter-Plugin austauschen kann.

## Links zu diesem Dokument

Alle Abschnitte dieses Leitfadens sind nummeriert, um das Nachschlagen und die Erstellung von Links zu erleichtern. Man kann direkt auf einen beliebigen Abschnitt verweisen indem man einfach einen Hashtag hinten an den Link http://ue4.style anhängt, gefolgt von der gewünschten Abschnittsnummer.
Möchte man zum Beispiel jemandem den ersten Grundsatz dieses Styleguides zusenden, so würde man `#0.1` an den Hauptlink anhängen. Hieraus resultiert dann der folgende Link: http://ue4.style#0.1.

## Forks und Übersetzungen

Sofern jemand einen interessanten Fork oder eine Übersetzung erstellt hat, der/die sich nicht für einen Pull Request in dieses Repository eignet, so ist es möglich einen PR einzureichen, um den Fork oder die Übersetzung hier hinzuzufügen.

* [Koreanische Übersetzung](https://github.com/ymkim50/ue4-style-guide/blob/master/README_Kor.md) von ymkim50
* [Russische Übersetzung](https://github.com/CosmoMyzrailGorynych/ue4-style-guide-rus/blob/master/README.md) von CosmoMyzrailGorynych
* [Japanische Übersetzung](https://github.com/akenatsu/ue4-style-guide/blob/master/README.jp.md) von akenatsu
* [Chinesische Übersetzung](https://github.com/skylens-inc/ue4-style-guide/blob/master/README.md) von Beijing Skylens Tech.
